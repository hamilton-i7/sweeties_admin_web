...
export default function Switch() {
  return (
    <RadixSwitch.Root className='w-[3.25rem] h-8 bg-surface-variant data-[state=checked]:bg-secondary rounded-full relative outline-none border-[0.125rem] border-outline border-solid data-[state=checked]:border-none cursor-default'>
